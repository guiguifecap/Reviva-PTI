Shader "Custom/StylizedLeaves_Arvore3"
{
    Properties
    {
        ...
        _MainColor           ("Main Color",                   Color)        = (0.231, 0.414, 0.308, 1)
        ...
        _ShadowColor         ("Shadow Color",                 Color)        = (0.143, 0.285, 0.190, 1)
        ...
        _DarkerShadowColor   ("Darker Shadow Color",           Color)        = (0.170, 0.309, 0.218, 1)
        ...
        _RelightShadowsColor    ("Relight Shadows Color",       Color)        = (0.255, 0.439, 0.313, 1)
        ...
        _HighlightColor      ("Highlight Color",               Color)        = (0.500, 0.683, 0.427, 1)
        _PositionHighlight   ("Position Highlight",              Range(0,1))   = 0.175
        _ContrastHighlight   ("Contrast Highlight",              Range(0,5))   = 2.0
        _FactorHighlight     ("Factor Highlight",                Range(0,5))   = 1.5

        [Header(__ Z GRADIENT __)]
        // Base da copa: RGB(41,79,39)
        _ZGradientColor      ("Z Gradient Color",              Color)        = (0.222, 0.410, 0.294, 1)
