Shader "Custom/StylizedLeaves_Arvore2"
{
    Properties
    {
        ...
        _MainColor           ("Main Color",                   Color)        = (0.375, 0.384, 0.158, 1)
        ...
        _ShadowColor         ("Shadow Color",                 Color)        = (0.284, 0.270, 0.007, 1)
        ...
        _DarkerShadowColor   ("Darker Shadow Color",           Color)        = (0.313, 0.288, 0.015, 1)
        ...
        _RelightShadowsColor    ("Relight Shadows Color",       Color)        = (0.442, 0.453, 0.159, 1)
        ...
        _HighlightColor      ("Highlight Color",               Color)        = (0.684, 0.688, 0.341, 1)
        ...
        _ZGradientColor      ("Z Gradient Color",              Color)        = (0.376, 0.407, 0.192, 1)
