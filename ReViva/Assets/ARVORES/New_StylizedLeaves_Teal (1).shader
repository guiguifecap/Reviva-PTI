Shader "Custom/New_StylizedLeaves_Teal"
{
    Properties
    {
        ...
        [Header(Base Colors)]
        _MainColor ("Main Color", Color) = (0.1, 0.68, 0.44, 1)
        _ShadowColor ("Shadow Color", Color) = (0.04, 0.22, 0.24, 1)
        _HighlightColor ("Highlight Color", Color) = (0.6, 0.92, 0.4, 1)
        ...
        [Header(Z Gradient)]
        _ZGradientColor ("Z Gradient Color Bottom", Color) = (0.03, 0.14, 0.19, 1)
