...
public class MenuUI_Jogo : MonoBehaviour
{
    ...
    //
    // MÉTODO DESATIVADO (comentado): toda a configuração via Input
    // Fields de Número de Séries / Pedras Por Descanso está desligada.
    // O Degrais passa a usar os valores do seu próprio Inspector.
    //
