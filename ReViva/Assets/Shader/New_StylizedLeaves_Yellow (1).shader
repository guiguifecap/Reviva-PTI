Shader "Custom/New_StylizedLeaves_Yellow"
{
    Properties
    {
        ...
        [Header(Base Colors)]
        _MainColor ("Main Color", Color) = (0.68, 0.7, 0.1, 1)
        _ShadowColor ("Shadow Color", Color) = (0.26, 0.22, 0.04, 1)
        _HighlightColor ("Highlight Color", Color) = (0.98, 0.82, 0.2, 1)
        ...
        [Header(Z Gradient)]
        _ZGradientColor ("Z Gradient Color Bottom", Color) = (0.2, 0.15, 0.02, 1)
